    ...
    <div className="relative min-h-screen bg-[#0B0E14] bg-grid-pattern overflow-hidden flex flex-col justify-between">
      ...
      <header className="relative z-10 max-w-7xl mx-auto w-full px-6 py-6 flex items-center justify-between">
        <div className="flex items-center gap-3 cursor-pointer" onClick={() => navigate("/")}>
          ...
          <div>
            <span className="text-2xl font-extrabold tracking-tight bg-gradient-to-r from-white via-slate-200 to-blue-400 bg-clip-text text-transparent">
              Classora
            </span>
          </div>
        </div>
      ...
      <main className="relative z-10 max-w-5xl mx-auto w-full px-6 py-12 flex-1 flex flex-col items-center justify-center text-center">
        ...
        <h1 className="text-5xl md:text-7xl font-black tracking-tight mb-6 leading-tight">
          <span className="block text-white">Classora</span>
